...
// import { Zap, Search, ShoppingCart, Menu, Leaf, LogOut } from "lucide-react";
// import { Input } from "@/components/ui/input";
// import { greenCreditsData } from "@/data/mockData";

// export function AmazonHeader() {
//   // Extracting setLocation to programmatically redirect the user
//   const [location, setLocation] = useLocation();

//   const handleLogout = () => {
//     // 1. Clear your authentication data here (e.g., localStorage, cookies, global state)
  ...
  return (
    <header className="bg-secondary text-secondary-foreground">
      ...
      <div className="bg-[#232f3e] text-white px-4 py-1 flex items-center gap-4 text-sm overflow-x-auto whitespace-nowrap scrollbar-hide">
        ...
        <Link
          href="/cart"
          className={`hover:outline hover:outline-1 hover:outline-white p-1 rounded-sm cursor-pointer ${location === '/cart' ? 'border-b-2 border-primary font-bold' : ''}`}
          data-testid="nav-p2p"
        >
          My Cart
        </Link>
