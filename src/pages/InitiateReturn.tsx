...
import { ArrowLeft, Package, ShieldCheck, AlertCircle, HelpCircle } from "lucide-react";
...
export default function InitiateReturn() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate routing to AI Assessment / Logistics
    setTimeout(() => {
      setIsSubmitting(false);
      toast.success("Return initiated! Redirecting to AI grading framework...");
      setLocation("/"); // Routes back to dashboard to see updated activity
    }, 1500);
  };
  ...
  return (
    <div className="bg-gray-50 min-h-screen py-8 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-3xl mx-auto">
        ...
        <button 
          onClick={() => setLocation("/")}
          className="flex items-center gap-2 text-sm text-gray-600 hover:text-primary transition-colors mb-6 cursor-pointer group"
        >
